    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchPlayers", x => new { x.MatchId, x.MatchPlayerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerPosition", x => new { x.PlayersPlayerId, x.PositionsPositionId });
                    table.ForeignKey(
                        name: "FK_PlayerPosition_Players_PlayersPlayerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchEvent_MatchPlayer",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchEvents_MatchId_MatchPlayerId",
                table: "MatchEvents",
